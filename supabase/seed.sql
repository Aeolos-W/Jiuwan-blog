...
('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Terence Tao', 'tao@math.ucla.edu', 'Mathematician at UCLA, Fields Medalist.');

-- 插入分类
INSERT INTO categories (id, name, slug, description, sort_order) VALUES
('c1b2c3d4-e5f6-7890-abcd-ef1234567891', 'Uncategorized', 'uncategorized', NULL, 0),
('c1b2c3d4-e5f6-7890-abcd-ef1234567892', 'Career advice', 'career-advice', 'Advice for mathematical careers', 1),
('c1b2c3d4-e5f6-7890-abcd-ef1234567893', 'On writing', 'on-writing', 'Advice on mathematical writing', 2),
('c1b2c3d4-e5f6-7890-abcd-ef1234567894', 'Books', 'books', 'Information about books', 3),
('c1b2c3d4-e5f6-7890-abcd-ef1234567895', 'Applets', 'applets', 'Mathematical applets and tools', 4);
...
('p1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Alice Math', 'alice@example.com', 'Great post! The connection to the complex plane is very elegant.', '2026-07-03 12:00:00+00', true),
('p1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Bob Number', 'bob@example.com', 'I wonder if similar bounds hold for other norms.', '2026-07-03 14:30:00+00', true),
('p1b2c3d4-e5f6-7890-abcd-ef1234567892', 'Carol Grad', 'carol@example.com', 'This is exactly what I needed to hear as I finish my PhD.', '2026-05-21 08:00:00+00', true);
...
('p1b2c3d4-e5f6-7890-abcd-ef1234567890', (SELECT id FROM tags WHERE slug = 'ai')),
('p1b2c3d4-e5f6-7890-abcd-ef1234567890', (SELECT id FROM tags WHERE slug = 'erdos-distance-problem')),
('p1b2c3d4-e5f6-7890-abcd-ef1234567890', (SELECT id FROM tags WHERE slug = 'number-field')),
('p1b2c3d4-e5f6-7890-abcd-ef1234567891', (SELECT id FROM tags WHERE slug = 'galois-theory')),
('p1b2c3d4-e5f6-7890-abcd-ef1234567891', (SELECT id FROM tags WHERE slug = 'inverse-galois-problem')),
('p1b2c3d4-e5f6-7890-abcd-ef1234567892', (SELECT id FROM tags WHERE slug = 'career-advice')),
('p1b2c3d4-e5f6-7890-abcd-ef1234567892', (SELECT id FROM tags WHERE slug = 'research')),
('p1b2c3d4-e5f6-7890-abcd-ef1234567893', (SELECT id FROM tags WHERE slug = 'writing')),
('p1b2c3d4-e5f6-7890-abcd-ef1234567893', (SELECT id FROM tags WHERE slug = 'mathematics'));
